...
const isChangesetBotNote = (
  ...
  (note.author.username === username
    || (random
      && RANDOM_BOT_NAME_PATTERN.exec(note.author.username)?.[1] === username)) // We need to ensure the note is generated by us, but we don't have an app bot like GitHub // @see https://github.com/apps/changeset-bot
